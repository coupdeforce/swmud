...
{
   // handle new people, old save files, or save files for which this option was disabled
   if (!colours) { colours = ([]); }

   // defaults; we take advantage of the fact that mapping addition chooses the second when there is an overlap.
