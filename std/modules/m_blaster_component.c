...
int max_ammo_recharge_time_bonus = 0;
...
string query_component_type() { return "blaster " + component_type; }
...
void set_range_bonus(int value)
{
   range_bonus = value;
}
...
void set_max_ammo_recharge_time_bonus(int value)
{
   max_ammo_recharge_time_bonus = value;
}

int query_max_ammo_recharge_time_bonus()
{
   return max_ammo_recharge_time_bonus;
}