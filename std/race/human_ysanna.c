...
int human_race_luc_min = 5;
int human_race_luc_max = 80;
int human_race_for_min = 45;
...
{
   return "The people of Ossus have survived due to their endurance and courage, and receive bonuses to constitution and charisma. Due to their strength in the Force they care little for luck.\n";
}
