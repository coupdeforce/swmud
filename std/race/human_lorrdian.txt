...
int human_race_agi_min = 40;
int human_race_agi_max = 90;
int human_race_dex_min = 5;
int human_race_dex_max = 80;
int human_race_per_min = 40;
...
{
   return "Lorrd is renowned for it's dedication to the arts, and some of the most talented actors in the galaxy come from the planet.  Lorrdians are good mimics and acrobats, and they are very charismatic.  A Lorrdian receives bonuses in charisma, agility, and perception, but they are not very good with their hands, as most of them have never worked a day in their lives.\n";
}
