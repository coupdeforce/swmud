...
{
   return "Blah blah Wookiees blah blah walking carpets blah blah.\n";
}

int query_race_str_min() { return 50; }
int query_race_str_max() { return 100; }
...
int query_race_dex_min() { return 35; }
...
int query_race_cha_min() { return 35; }
int query_race_cha_max() { return 85; }
