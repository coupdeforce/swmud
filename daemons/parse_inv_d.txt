...
//      case "get": return deep_inventory(thing) + all_inventory(environment(thing));
      ...
      case "uninstall": return filter_array(filter_array(deep_inventory(thing), (: $1->is_lightsaber_component() :)), (: environment($1)->is_lightsaber() :)) + filter_array(all_inventory(thing), (: $1->is_lightsaber() :)) + filter_array(filter_array(deep_inventory(thing), (: $1->is_blade_component() :)), (: environment($1)->is_blade() :)) + filter_array(all_inventory(thing), (: $1->is_blade() :));
