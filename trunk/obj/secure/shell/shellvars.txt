...
void setup_for_save()
{
   ...
   // bound to require M_SAVE.  The objects this module is applied
...
protected void set_if_undefined(string var, mixed value)
{
   if (!is_variable(var))
   {
...
protected void print_variable(string v)
{
...
// This is the implementation of the command interface to this module from a shell command line.
