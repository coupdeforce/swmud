//:MODULE
//This module can be used to make objects decay after a set amount of time.
//You may also have an object decay in stages.
...
//Setting this makes the item decayable, not setting this variable will not make it decay.
