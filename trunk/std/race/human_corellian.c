...
int human_race_per_max = 85;
int human_race_int_min = 5;
int human_race_int_max = 80;
int human_race_cha_min = 35;
int human_race_cha_max = 90;
int human_race_luc_min = 40;
...
{
   return "Corellians rely on quick wits and luck to survive in the galaxy, so they receive bonuses to luck, agility, and dexterity. Due to their reckless nature, however, they are not considered to be the most intelligent beings.\n";
}
