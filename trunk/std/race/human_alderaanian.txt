...
int human_race_agi_min = 5;
int human_race_agi_max = 80;
int human_race_dex_min = 30;
int human_race_dex_max = 90;
int human_race_per_min = 45;
int human_race_per_max = 90;
int human_race_int_min = 45;
int human_race_int_max = 90;
int human_race_cha_min = 30;
int human_race_cha_max = 90;
int human_race_luc_min = 45;
int human_race_luc_max = 90;
int human_race_for_min = 30;
...
{
   return "The people of Alderaan are kind and gentle, and care about the environment of their home planet.  The vast libraries and large universities make most Alderaanians very intelligent and perceptive, and the seamless way with which they bond with nature leads most to believe they are rather lucky.  Due to their posh lifestyle, however, they are not as agile as other humans.\n";
}
