...
{
   return "Blah blah Jawas blah blah.\n";
}

int query_race_str_min() { return 30; }
int query_race_str_max() { return 80; }
...
int query_race_luc_min() { return 45; }
int query_race_luc_max() { return 95; }
