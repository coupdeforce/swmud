// Maintains a list of products that can be manufactured
#include <security.h>
#include <classes.h>
...
int add_product(string internal_name, string product_name, string product_filename, mixed array product_guild_requirements, mixed array product_skill_requirements, string array product_learn_requirements, string array product_race_requirements, mixed array product_item_list, mixed array product_tool_list)
{
