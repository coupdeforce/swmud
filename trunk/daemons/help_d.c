// File: help_d.c
// Created by Deathblade for the new help system 10-25-1994 

// This daemon keeps track of topic->pathname mappings.
// It will also manage a topic name appearing in multiple locations.
#include <mudlib.h>
#include <dirs.h>
...
private nosave int last_time = 0;
...
// player's level).  Otherwise, an array of pathnames will be returned.
nomask string * find_topic(string name)
{
   mixed *result;
   int lvl;

   if (!this_body()) { return 0; }
