...
void setup()
{
   set_id("pistol shoulder holster", "shoulder holster", "holster");
   set_long("A brown leather holster with open pouches for two pistols, which you can wear around your chest.");
